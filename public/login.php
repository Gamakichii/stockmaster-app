<?php
// public/login.php - Removed "Forgot Password?" link
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                log_action('login_success'); // Log successful login action
...
<div class="flex items-center justify-center min-h-[calc(100vh-200px)]">
    <div class="max-w-md w-full bg-white p-8 border border-gray-300 rounded-lg shadow-lg m-4">
        ...
        <form action="login.php" method="POST" novalidate>
            ...
            <?php // --- Link Removed From This Block --- ?>
            <div class="flex items-center justify-center mb-4"> <?php // Changed justify-between to justify-start ?>
                <button type="submit"
                ...
                <?php // The Forgot Password <a> tag was here and has been removed ?>
            </div>
